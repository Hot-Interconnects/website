  ...
  <tbody>
    ...
    <tr style="vertical-align: top;">
      <td style="width: 30%; padding: 10px; text-align: center; font-size: 1.3em;">
        <img src="assets/img/Inder_Monga_panelist.jpeg" alt="Inder Monga" style="width: 150px; height: auto; display: block; margin: 0 auto;"><br>
        <strong>Inder Monga </strong><br>
    ...
    <tr style="vertical-align: top;">
      ...
      <td style="width: 75%; padding: 10px; font-size: 1.2em;">
        Ofer Shapiro is CEO and Co-Founder of Resolight.ai, which believes the real breakthrough comes from coupling co-packaged optics (CPO) with the right network architecture. The data should be converted once at the transmitter and once at the receiver — and remain light throughout the network. This is the promise of Resolight’s native photonic processor: light-speed optical switching designed for AI scale-up networks. This architecture is built to reduce energy beyond what CPO can achieve on its own, unlock much larger scale-up radix, and enable AI clusters that are larger, faster, and more efficient.
        <br><br>
    ...
    <tr style="vertical-align: top;">
      ...
      <td style="width: 75%; padding: 10px; font-size: 1.2em;">
        Amy Leeland has been pushing the envelope in both cloud and edge computing for 20 years. In her 15 years at Intel she led initiatives in cloud and hyperscale software, open-source ecosystems, and edge computing. At Cloudflare she focused on network hardware, systems optimization, and performance engineering. Two years ago she was recruited to GEICO to head compute and storage-systems engineering where she is leading the revival of enterprise data centers. She thrives on finding creative solutions to complex system problems following the principles of teamwork, a growth mindset, and action.
      </td>
    </tr>
  </tbody>
</table>